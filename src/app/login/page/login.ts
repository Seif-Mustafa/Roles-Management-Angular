    ...
    template: `
        ...
        <div class="bg-surface-50 dark:bg-surface-950 flex items-center justify-center min-h-screen min-w-screen overflow-hidden">
            ...
            <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)">
                    <div class="w-full bg-surface-0 dark:bg-surface-900 py-18 px-8 sm:px-20" style="border-radius: 53px">
                    ...
                    <svg viewBox="0 0 54 40" fill="none" xmlns="http://www.w3.org/2000/svg" class="mb-6 w-16 shrink-0 mx-auto">
                        ...
                        <div>
                            ...
                            <div class="text-center mt-6 text-surface-500">
                                <span class="text-sm font-bold">Deployment Date: 10/28/2025</span>
                            </div>
                        </div>
                    </div>
                </div>
...
export class Login {
    ...
    login(): void {
        let user: LoggedUser;
        this.loginService.checkCredentials(this.email, this.password).subscribe({
            next: (res) => {
              console.log("res>", res);
                user = res.data as LoggedUser;
