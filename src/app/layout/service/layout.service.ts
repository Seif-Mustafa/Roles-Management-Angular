...
export class LayoutService {
    ...
    // Placeholder method to check user session (implement based on your auth mechanism)
    private checkUserSession(): void {
        // This is where you would check for an existing session/token
        // For example, check localStorage or make an API call
        const storedUser = localStorage.getItem('loggedUser');
        if (storedUser) {
            this.setLoggedUser(JSON.parse(storedUser));
        }
    }
}
